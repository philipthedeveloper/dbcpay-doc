...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    This documentation gives full details into the DBCPay component library. From prop documentation, to interactivity, this documation provides comprehensive information about each components. This documentation however does not contain information about the installation.
    For information about documentation. <a
        href="https://dbcpay-component-doc.netlify.app/guides/installation/"
        target="_blank">Visit here<RightArrow /></a>
  </div>
